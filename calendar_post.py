...
【重要な指示】
1. 古めかしい口調（「でございます」「〜なのでございます」など）は使わず、現代的で親しみやすい文章で書いてください
2. 「ですます調」で、読者に語りかけるような温かい口調を使ってください
3. 箇条書き（• や - など）を積極的に使い、読みやすく整理してください
4. 各セクションは300文字以上、具体的で詳しい内容にしてください
5. 前置きは一切不要です。「☀️ 季節の移ろい」からすぐに始めてください

【出力フォーマット】
以下の章立てで必ず出力し、🎼 伝統芸能まで完結させてください。それ以降は何も書かないでください。
...
【文体の例】
良い例：「今は二十四節気の{sekki[0]}の時期です。この頃は〜」
悪い例：「今は二十四節気の{sekki[0]}の時期でございます。この頃は〜なのでございます」

それでは、親しみやすく温かい文章で、本日の暦情報を詳しく解説してください。"""
